...
<html lang="en">
    ...
    <body>
                                ...
                                <div class="row">
                                    <div class="col-md-12 nav-link-wrap">
                                        <div class="nav nav-pills text-center" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                            <a class="nav-link active mr-md-1" id="v-pills-1-tab" data-toggle="pill" href="#v-pills-1" role="tab" aria-controls="v-pills-1" aria-selected="true">Find an Auction</a>
                                                                ...
                                                                <div class="form-field">
                                                                    <div class="select-wrap">
                                                                        ...
                                                                        <select name="" id="" class="form-control">
                                                                            ...
                                                                            <%
                                                                                for (String category : Constant.HOME_PAGE_AUCTION_CATEGORY) {
                                                                            %>
                    ...
                    <div class="col-md-3 d-flex align-self-stretch ftco-animate">
                        <div class="media block-6 services d-block">
                            ...
                            <div class="media-body">
                                <h3 class="heading mb-3">Search Auction</h3>
                                <p>You can search your needed service by auction online.</p>
                            </div>
                        </div>      
                    </div>
                    <div class="col-md-3 d-flex align-self-stretch ftco-animate">
                        <div class="media block-6 services d-block">
                            ...
                            <div class="media-body">
                                <h3 class="heading mb-3">Easy To Manage Auction</h3>
                                <p>The total process of online auction is user friendly.</p>
                            </div>
                        </div>    
                    </div>
                    <div class="col-md-3 d-flex align-self-stretch ftco-animate">
                        <div class="media block-6 services d-block">
                            ...
                            <div class="media-body">
                                <h3 class="heading mb-3">Maintain Quality</h3>
                                <p>We maintain the quality of every service.</p>
                            </div>
                        </div>      
                    </div>
                    <div class="col-md-3 d-flex align-self-stretch ftco-animate">
                        <div class="media block-6 services d-block">
                            ...
                            <div class="media-body">
                                <h3 class="heading mb-3">Search Job</h3>
                                <p>You can also search job from here.</p>
                            </div>
                        </div>      
                    </div>
                </div>
        ...
        <jsp:include page="topcategory.jsp"></jsp:include>                                                                    

            <section class="ftco-section img" style="background-image: url(images/project_one.jpg); background-position: top center;">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
            ...
            <section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(images/project.jpg);" data-stellar-background-ratio="0.5">
                <div class="container">
